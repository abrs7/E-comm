...
const Services = () => {
	...
	<div className="col-md-4">
		...
		<p className="card-text lead">some quick example text to build on the card title and make up the card's content.</p>
		</div>
		</div>
	</div>
	<div className="col-md-4">
	...
	<div className="col-md-4">
		...
		<p className="card-text lead">some quick example text to build on the card title and make up the card's content.</p>
		<a href="#" class="btn btn-primary">Go to our services</a>
		</div>
		</div>
	</div>
	<div className="col-md-4">
	...
	<div className="col-md-4">
		...
		<p className="card-text lead">some quick example text to build on the card title and make up the card's content.</p>
		<a href="#" className="btn btn-primary">Go to our services</a>
		</div>
		</div>
